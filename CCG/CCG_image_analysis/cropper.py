...
# Example usage:
input_dir = './Cropped/Round-1 NTC'  # Directory containing input images
output_base_dir = './Cropped/Round_1_NTC'  # Base directory for saving cropped images

process_images_in_directory(input_dir, output_base_dir)
